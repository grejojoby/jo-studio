...
export function App() {
  ...
  const controlsDisabled = !studio.isReady || studio.isBusy || studio.isRecording || studio.isExporting;
    ...
    <div className="app-shell studio-console">
      <header className="studio-bar">
        ...
        <div className="header-actions">
          ...
          <ExportPanel disabled={!studio.selectedTake || controlsDisabled} exporting={studio.isExporting}
          ...
          <button className="quiet-button" type="button" disabled={controlsDisabled}
            onClick={() => void studio.clearSession()} aria-label="Clear session">Clear</button>
        </div>
      </header>
      ...
      <main id="studio" className="studio-stage">
        <div className="studio-layout" aria-busy={!studio.isReady || studio.isBusy || studio.isExporting}>
          <div className="recording-column">
            <TrackWorkspace project={studio.project} selectedTake={studio.selectedTake}
              ...
              recording={studio.isRecording} playing={studio.isPlaying}
              positionSeconds={studio.positionSeconds} livePeaks={studio.livePeaks}
